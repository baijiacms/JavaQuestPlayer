package com.qsp.player.core.game.service;
...
import com.qsp.player.core.util.StringUtil;
import com.qsp.player.core.util.ThreadUtil;
...
public class AudioPlayer {
    ...
    private QspAudioMediaPlayer localQspAudioMediaPlayer;
    public AudioPlayer(QspAudioMediaPlayer qspAudioMediaPlayer) {
        this.localQspAudioMediaPlayer = qspAudioMediaPlayer;
    }
    public void start() {
    ...
    private void doPlay(final Sound sound) {
        ...
        QspAudioMediaPlayer player = this.localQspAudioMediaPlayer.createNewPlayer(file.getAbsolutePath());
...
//        player.setOnCompletionListener(mp -> sounds.remove(sound.path));
    ...
    private static class Sound {
        private String path;
        private int volume;
        private QspAudioMediaPlayer player;
    }
}
