...
import com.qsp.player.core.*;
import com.qsp.player.core.util.Base64Util;
...
import com.qsp.player.core.model.*;
...
public class GameShower implements GameInterface {
    ...
    private QspViewInterface qspViewInterface;
    public  GameShower(Class runnerClass, QspViewInterface qspViewInterface, QspAudioMediaPlayer qspAudioMediaPlayer)
    {
        this.qspViewInterface = qspViewInterface;
        QspConstants.setBaseFoler(JarUtil.getJarPath(runnerClass));
        this.mEngine =new QuestPlayerEngine(qspAudioMediaPlayer);
        onCreate();
        //applyGameState();
    }
    ...
    public void showError(String message) {
        ...
        qspViewInterface.showErrorBox(message);
    }
    ...
    public void showPicture(String path) {
       // logger.info("gameDirUri:"+libQspProxy.getGameState().gameDir.getAbsolutePath());
        ...
        this.qspViewInterface.showPicture( path);
    }
    ...
    public void showMessage(String message) {
        ...
        this.qspViewInterface.showMessageBox(message);
    }
    ...
    public String showInputBox(String prompt) {
        ...
        return qspViewInterface.getInputStr(message);
    }
